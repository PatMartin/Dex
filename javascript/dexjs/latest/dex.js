...
module.exports = c3;
},{"./AreaChart":4,"./BarChart":5,"./C3Chart":6,"./DonutChart":7,"./LineChart":8,"./PieChart":9,"./ScatterPlot":10,"./StackedAreaChart":11,"./StackedBarChart":12}],14:[function(require,module,exports){
...
module.exports = function (dex) {
   ...
   *
   */
  color.shadeColor = function (color, percent) {
   ...
   *
   */
  color.blendColors = function (color1, color2, percent) {
   ...
   *
   */
  color.colormap = function (palette, presets) {
   ...
   *
   */
  color.colormaps = function (options) {
    var opts = options || {};
    if (opts.shortlist) {
      return [
        "ECharts",
   ...
   *
   */
  color.interpolateCategorical = function (domain, range) {
    var color = d3.scale.ordinal()
      .domain(domain)
   ...
   *
   */
  color.getColormap = function (paletteName, presets) {
...
module.exports = function (dex) {
   ...
   *
   * @memberof dex/datagen
   *
   */
  datagen.randomMatrix = function (spec) {
    var ri, ci;
  ...
  datagen.randomIndexedMatrix = function (spec) {
    var ri, ci;
  ...
  datagen.randomIndexedIntegerMatrix = function (spec) {
    var ri, ci;
  ...
  datagen.randomIntegerMatrix = function (spec) {
    var ri, ci;
   ...
   *
   */
  datagen.identityCsv = function (spec) {
    var ri, ci;
    var csv = {};
   ...
   *
   */
  datagen.identityMatrix = function (spec) {
    var ri, ci;
   ...
   *
   */
  datagen.identityHeader = function (spec) {
    return dex.range(1, spec.columns).map(function (i) {
      return "C" + i;
    });
  };

  datagen.usStateInfo = function (format) {
    var stateData = [
      {
        "name": "Alabama",
        "abbreviation": "AL"
...
module.exports = function (dex) {
   ...
   *
   */
  matrix.slice = function (matrix, columns, rows) {
   ...
   *
   */
  matrix.uniques = function (matrix, columns) {
 ...
 *
   ...
   *
   */
  matrix.extent = function (matrix, indices) {
    var values = matrix;
   ...
   *
   */
  matrix.combine = function (matrix1, matrix2) {
   ...
   *
   */
  matrix.addIndex = function (matrix) {
   ...
   *
   */
  matrix.isColumnNumeric = function (matrix, columnNum) {
   ...
   *
   */
  matrix.max = function (matrix, columnNum) {
   ...
   *
   */
  matrix.min = function (matrix, columnNum) {
