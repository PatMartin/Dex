 ...
 * 
 */
public class ReflectiveMouseDragEventHandler implements
    EventHandler<MouseEvent>
{
   ...
   */
  public ReflectiveMouseDragEventHandler(Object target, String handlerMethodName)
  {
    this.target = target;
   ...
   */
  public void handleError(MouseDragEvent event)
  {
    System.err.println("Invalid ReflectiveMouseDragEventHandler: TARGET='"
