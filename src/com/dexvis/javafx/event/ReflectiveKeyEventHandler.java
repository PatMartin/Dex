 ...
 * 
 */
public class ReflectiveKeyEventHandler implements EventHandler<KeyEvent>
{
  // The target object.
   ...
   * the form: public void someMethod(KeyEvent evt)
   * 
   * @param target
   *          The target object.
   ...
   */
  public ReflectiveKeyEventHandler(Object target, String handlerMethodName)
  {
    this.target = target;
   ...
   */
  public void handleError(KeyEvent event)
  {
    System.err.println("Invalid ReflectiveKeyEventHandler: TARGET='"
        + target + "', TARGET-CLASS='" + target.getClass() + ", METHOD='"
        + handlerMethodName + "'");
  }
}
