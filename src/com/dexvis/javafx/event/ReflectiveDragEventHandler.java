 ...
 * 
 */
public class ReflectiveDragEventHandler implements EventHandler<DragEvent>
{
  // The target object.
   ...
   */
  public ReflectiveDragEventHandler(Object target, String handlerMethodName)
  {
    this.target = target;
   ...
   */
  public void handleError(DragEvent event)
  {
    System.err.println("Invalid ReflectiveDragEventHandler: TARGET='" + target
