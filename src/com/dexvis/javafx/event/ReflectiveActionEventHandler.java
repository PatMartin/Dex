 ...
 * 
 */
public class ReflectiveActionEventHandler implements EventHandler<ActionEvent>
{
  // The target object.
   ...
   */
  public ReflectiveActionEventHandler(Object target, String handlerMethodName)
  {
    this.target = target;
  ...
  {
    System.err.println("Invalid ReflectiveActionEventHandler: TARGET='"
