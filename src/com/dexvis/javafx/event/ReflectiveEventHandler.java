 ...
 * 
 */
public class ReflectiveEventHandler implements EventHandler<Event>
{
  // The target object.
   ...
   */
  public ReflectiveEventHandler(Object target, String handlerMethodName)
  {
    this.target = target;
   ...
   */
  public void handleError(Event event)
  {
    System.err.println("Invalid ReflectiveKeyEventHandler: TARGET='" + target
