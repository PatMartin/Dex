...
class JarInspector extends DexTask {
  ...
  public Node getConfig()
  {
    if (configPane == null)
    {
      ...
      jarListView.setOnKeyPressed(new ReflectiveKeyEventHandler(this,
          "keyPress"))
    }
  ...
  public void keyPress(KeyEvent evt)
  {
    if (evt.getCode().equals(KeyCode.DELETE))
    {
      ...
      jarData.remove(jarListView.getSelectionModel().getSelectedIndex())
    }
    else
    {
  ...
  public void open(ActionEvent evt)
  {
    try
    {
      ...
      {
        jarData.add(file.getAbsolutePath())
      }
    }
    catch(Exception ex)
    {
