...
class JavaFXPieChart extends DexTask {
  ...
  public Node getConfig()
  {
    if (configPane == null)
    {
      ...
      legendVisibleCB.setOnAction(new ReflectiveActionEventHandler(this, "toggleLegend"))

      legendSideCB.getSelectionModel().selectedIndexProperty().addListener(new ReflectiveChangeListener(this, "changeLegendSide"))
