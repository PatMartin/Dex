...
class JavaFXBubbleChart extends DexTask {
  ...
  List<Color> colorwheel = [Color.BLUE, Color.GREEN, Color.RED, Color.CYAN, Color.PURPLE, Color.YELLOW]
  ...
  public Node getConfig()
  {
    if (configPane == null)
    {
      ...
      opacitySlider.valueProperty().addListener((ChangeListener){obj, oldVal, newVal -> changeOpacity(obj, oldVal, newVal)})
      maxSizeSlider.valueProperty().addListener((ChangeListener){obj, oldVal, newVal -> changeMaxBubbleSize(obj, oldVal, newVal)})
      ...
      xListView.getSelectionModel().selectedItemProperty().addListener((ChangeListener){obj, oldVal, newVal ->
        updateChart(obj, oldVal, newVal)})
      yListView.getSelectionModel().selectedItemProperty().addListener((ChangeListener){obj, oldVal, newVal ->
        updateChart(obj, oldVal, newVal)})
      zListView.getSelectionModel().selectedItemProperty().addListener((ChangeListener){obj, oldVal, newVal ->
        updateChart(obj, oldVal, newVal)})
      oListView.getSelectionModel().selectedItemProperty().addListener((ChangeListener){obj, oldVal, newVal ->
        updateChart(obj, oldVal, newVal)})
